// TAG Solutions — client testimonials (ported from the current site).
export const testimonials = [
  {
    quote:
      "Tags turned my vision into a leading restaurant reservation platform. Their AI expertise and innovation set us apart. Tags didn't just deliver a project — they delivered our future.",
    name: "Steven Davis",
    role: "CEO at Have A Seat",
